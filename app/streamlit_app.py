...
BACKTEST_NOTES = {
    ...
    "swing": {
        ...
        "glossary": (
            "- **CANSLIM（William O'Neil 成長股篩選法）**：原本是七個條件的縮寫（當季獲利、"
            "年度獲利、新產品/新高、籌碼供需、產業龍頭、法人認養、大盤方向），**這裡只借用"
            "基本面那幾條**（季 EPS 年增、近 3 年 EPS 成長、ROE、毛利率沒連續惡化），"
            "不是完整七條都做，也沒有另外判斷大盤方向。\n"
            "- **F-Score**：同價值清單那個 Piotroski 財務體質分數，這裡當基本面門檻之一"
            "（≥6），不是選股主力。\n"
