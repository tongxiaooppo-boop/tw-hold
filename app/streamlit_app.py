...
BACKTEST_NOTES = {
    ...
    "swing": {
        ...
        "backtest": (
            "**實驗 E（2026-09-14，事件驅動回測，2016-01→2026-09，550 週，"
            "universe 609 檔，市況進場 × 移動停損組合矩陣，共 7 種口徑）**：\n\n"
            "| 口徑 | 年化 | 最大回撤 | 勝率 |\n"
            "| :-- | --: | --: | --: |\n"
            "| 次日開盤（PRD 字面規格：不限市況、固定停損） | +13.2% | −37.1% | 25% |\n"
            "| 限價買得到（固定停損） | +11.7% | −37.1% | 23% |\n"
            "| 次日開盤 + 移動 ATR 停損（不限市況） | +19.3% | −31.2% | 42% |\n"
            "| 只留多頭週（M gate）+ 固定停損 | +7.0% | −43.2% | 28% |\n"
            "| 只留多頭週（M gate）+ 移動 ATR 停損 | +7.1% | −31.6% | 41% |\n"
            "| 排除空頭週 + 固定停損 | +14.3% | −36.9% | 28% |\n"
            "| **✅ 排除空頭週 + 移動 ATR 停損（現行規格）** | **+21.9%** | **−29.4%** | 43% |\n"
            "| 排除空頭週 + 市況緊縮停損（空頭/震盪收緊到1.5×ATR） | +27.7% | −39.5% | 41% |\n"
            ...
            "年化確實更高（+27.7%），但最大回撤反而惡化到 −39.5%（比不緊縮的 −29.4% 更深）"
            ...
            "**分市況（0050 代理，`reference.regime`，累積報酬不是年化）**：\n\n"
            "| 口徑 | 多頭（1136天） | 震盪（854天） | 空頭（404天） |\n"
            "| :-- | --: | --: | --: |\n"
            "| 次日開盤（不限市況、固定停損） | +518.1% | +36.5% | −55.8% |\n"
            "| 移動 ATR 停損（不限市況） | +235.8% | +210.6% | −36.8% |\n"
            "| 只留多頭週（M gate）+ 固定停損 | +503.2% | −24.2% | −55.0% |\n"
            "| **✅ 排除空頭週 + 移動 ATR 停損（現行規格）** | +226.9% | **+213.7%** | "
            "**−19.2%** | \n"
            "| 排除空頭週 + 市況緊縮停損 | +233.1% | +324.0% | −4.4% |\n\n"
            "獲利幾乎全部來自多頭（候選池本來就偏動能/趨勢股，正常）；現行規格在震盪期"
            "維持移動停損的優勢（+213.7%），同時因為排除空頭週新進場，空頭期虧損"
            "（−19.2%）比不篩市況的版本（−36.8%）更淺——這是市況篩選真正貢獻的地方，"
            "不是「少曝險=安全」這種直覺，是空頭週的候選池訊號品質本身就比較差，篩掉"
            "有實質作用。\n\n"
            "完整結果：`docs/reports/backtest_longswing_20260914.md`。\n\n"
            ...
            "| 年 | 策略 | 0050 |\n"
            "| :-- | --: | --: |\n"
            "| 2016 | 當年無訊號 | +22.1%（168.3） |\n"
            "| 2017 | 當年無訊號 | +18.0%（198.8） |\n"
            "| 2018 | 當年無訊號 | −5.5%（189.0） |\n"
            ...
            "| **最大回撤** | −27.4% | — |\n"
            "| **MAR** | 1.41／1.42 | — |\n\n"
            "獲利集中在 2021/2023/2024/2025 幾個多頭年份，2016-2018 候選池還沒建起來"
            "（無訊號）、2019-2020 小賠、2022 空頭小賠、2026 明顯放緩——**跟連續複利版"
            "2026-09-14 那份「純事件驅動、不設本金上限」的回測方向一致**（移動停損 + "
            "市況篩選確實有效），資金天花板版數字更高是因為多頭年份用複利部位重壓放大"
            "了效果，**兩份用不同方法論互相佐證同一個結論，不是互相矛盾**。完整數字："
            ...
            "| 年 | N=5 | N=10 | 0050 |\n"
            "| :-- | --: | --: | --: |\n"
            "| 2016 | 當年無訊號 | 當年無訊號 | +22.1% |\n"
            "| 2017 | 當年無訊號 | 當年無訊號 | +18.0% |\n"
            "| 2018 | 當年無訊號 | 當年無訊號 | −5.5% |\n"
            ...
            "| **贏 0050 的年數** | **6/11** | **6/11** | — |\n\n"
            "**拆開複利路徑依賴後長波段逐年贏 0050 六次**（2018 候選池尚未建起、"
            "0% 也算贏 0050 當年 −5.5%；加上 2021-2025 連續五年），比價值線"
            "（2/11）跟短線三條規則（5/11 或 7/11）都更穩定——2021 那年 +186% "
            "是單一年份的爆發，不是連續複利下由前幾年小賺墊高本金堆出來的假象。"
            "已知限制同短線的每年歸零重跑。完整表格："
            "`tw-hold/docs/reports/backtest_scenario_b_yearly_reset_2026-09-22.md`"
            "〈長波段候選池〉一節。\n\n" + _WHY_0050),
    },
