...
BACKTEST_NOTES = {
    "value": {
        ...
        "backtest": (
            "**實驗 B'（2026-09-12，port 版，季換股回溯，2016-03→2026-06，41 期）**：N=10 "
            "含息年化 **+23.13%**、最大回撤 **−30.9%**；同期 0050 含息 **+24.16%**、回撤 "
            "**−17.6%**——**年化接近大盤，但回撤明顯更深**。N=20 年化 +25.75%（小勝 0050）、"
            "回撤 −26.8%，一樣更深。**對照組（不排序、過門檻就全買，N=∞）反而年化最高"
            "（+28.86%）、回撤最淺（−20.5%）**——排名機制本身在這段期間沒有幫上忙。\n\n"
