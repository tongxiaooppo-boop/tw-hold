...
**2026-09-11 二次改名 → 「股市雷達」**（配色改版順便重定表頭）。中途曾考慮
「選股雷達」「智慧股市雷達」，兩個都被否決——前者踩了上面刻意避開的「選股」，
後者「智慧」易誤會成 AI/投顧判斷（tw-hold 是純規則、無 runtime LLM）。
「雷達」承接「觀測站」的持續掃描/監測意象，但不帶「選股」「智慧」這類暗示
主動判斷或 AI 介入的字眼。
